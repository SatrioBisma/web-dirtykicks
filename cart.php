...
if(isset($_POST["update"])){
	...
	if($q1){
		...
		echo 'alert("Pesanan per produk minimal 50 makanan/minuman")';  //not showing an alert box.
		echo '</script>';
...
<html>
<head>
<title>DIRTYKICKS - KERANJANG</title>
<!-- for-mobile-apps -->
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="Soto Ayam Grafika" />
	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
			...
			<div class="w3ls_logo_products_left">
				<h1><a href="index.php" style="judul">DIRTYKICKS</a></h1>
			</div>
						...
						<td class="invert">
							 <div class="quantity"> 
								<div class="quantity-select">                     
									<input type="number" placeholder="Masukkan jumlah (minimal 50)" name="jumlah" class="form-control" height="100px" value="<?php echo $b['qty'] ?>" \>
								</div>
							</div>
						</td>
...
<div class="footer">
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					<h3>Hubungi Kami</h3>
					<ul class="address">
						<li><a href="https://maps.app.goo.gl/mAu9i4pq6ixAcGM7A" class=""><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i></a>Jl. Sadewa 1 No. 31, Kec. Semarang Tengah, Kota Semarang, Jawa Tengah 50131</li>
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>0878-1009-4548</li>
					</ul>
				</div>
				<div class="col-md-3 w3_footer_grid">
					...
					<ul class="info"> 
						...
						<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="howto.html">Cara Pesan</a></li>
		...
		<div class="footer-copy">
			...
			<div class="container">
			<p>© 2023 Creation. All rights reserved</p>
			</div>
		</div>
	...
	<div class="footer-botm">
			<div class="container">
				<div class="w3layouts-foot">
					<ul>
						<li><a href="https://www.instagram.com/dirtykicks.id/" class="w3_agile_instagram"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
					</ul>
				</div>
