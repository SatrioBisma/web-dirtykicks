...
if(!isset($_SESSION['log'])){
	...
	$jumlah = mysqli_query($conn, "select qty from detailorder where orderid='$orderidd'");
...
<html>
<head>
<title>DIRTYKICKS - CHECKOUT</title>
<!-- for-mobile-apps -->
...
<!-- checkout -->
	<div class="checkout">
		<div class="container">
			<h1>Terima kasih, <?=$_SESSION['name']?> telah memesan <?php echo $itungtrans3 ?> layanan di DIRTYKCIKS</span></h1>
