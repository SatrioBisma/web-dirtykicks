	...
	<div class="navigation-agileits ">
		<div class="container">
			<nav class="navbar navbar-default ">
							...
							<div class="collapse navbar-collapse" style="text-align: center;"id="bs-megadropdown-tabs ">
...
<!-- //navigation -->
	<!-- main-slider -->
		...
		<ul id="demo1">
			<li>
				<img src="images/cintai sepatumu2.jpg" alt="" />
			</li>
			<li>
			...
			<li>
				<img src="images/helm hasil.jpg" alt="" />
			</li>
		</ul>
	<!-- //main-slider -->
